export default function SelfPublishingFantasySeriesLessonsLearned() {
  return (
    <>
      <p>
      ...
      <ul>
        ...
        <li><strong>World-building consistency guides</strong> (because readers WILL catch contradictions)</li>
      ...
      <ul>
        <li>Test your covers at thumbnail size (how they appear in Amazon search)</li>
        <li>Study the top 20 books in your subgenre&apos;s bestseller lists</li>
        <li>Ensure your cover clearly communicates genre expectations</li>
        <li>Plan your entire series cover design before publishing book one—readers should immediately recognize books 2-8 as part of your series</li>
      </ul>

      <h2>KDP and Platform Strategy: What Actually Works</h2>
      ...
      <ul>
        <li>Kindle Unlimited dramatically increases page reads</li>
        <li>Free promotional periods generate significant list building opportunities</li>
        <li>Amazon pushes Select titles harder in recommendations</li>
      </ul>
      <p><strong>KDP Select Cons:</strong></p>
      <ul>
        <li>You&apos;re locked into Amazon&apos;s ecosystem completely</li>
        <li>Algorithm changes can devastate your income overnight</li>
      ...
      <ul>
        <li>KDP Rocket (now Publisher Rocket) for keyword research</li>
        <li>KindleTrends for category analysis</li>
        <li>Amazon&apos;s own search suggestions reveal what readers actually search for</li>
      </ul>

      <h2>Building an Author Platform While Writing</h2>
      ...
      <ul>
        <li>Choose ONE primary platform and master it completely</li>
        <li>Newsletter building trumps social media followers every time</li>
      ...
      <ul>
        ...
        <li><strong>World-building insights</strong> that add depth to their reading experience</li>
        <li><strong>Character analysis</strong> that helps them understand motivations</li>
        <li><strong>Reading recommendations</strong> that position you as a knowledgeable guide</li>
      </ul>
      ...
      <h2>The Economics of Series Publishing</h2>
      ...
      <ul>
        <li>Book 1: $2.99 (loss leader to hook readers)</li>
        <li>Books 2-8: $4.99-$6.99 (depending on length and market position)</li>
        <li>Occasional $0.99 promotions on book 1 during new releases</li>
      </ul>
      <p><strong>What I learned about pricing psychology:</strong></p>
      <ul>
        <li>Readers expect epic fantasy to cost more than romance</li>
        <li>Series pricing should escalate gradually—jumping from $2.99 to $6.99 feels jarring</li>
        <li>Promotional pricing works best when tied to specific events (new releases, holidays)</li>
      </ul>
      ...
      <ul>
        <li>Professional editing: $1,500-$3,000 (depending on length)</li>
        <li>Cover design: $300-$800</li>
        <li>Formatting: $200-$400 (or learn to DIY)</li>
        <li>Marketing ads: $500-$2,000 per launch</li>
        <li>Series bible maintenance: 10-15 hours per book (your time costs something)</li>
      </ul>
      <p><strong>Optional but valuable:</strong></p>
      <ul>
        <li>Beta readers (coordination time)</li>
        <li>Professional marketing consultation: $500-$2,000</li>
        <li>Book trailer production: $200-$1,000</li>
      ...
      <ul>
        <li>50+ advance review copies sent to genre bloggers</li>
        <li>Guest posts on fantasy websites</li>
        <li>Coordinated social media campaign</li>
        <li>Email sequences to existing readers</li>
      ...
      <ul>
        <li><strong>Cross-promotion with similar authors:</strong> Trade newsletter mentions, co-author guest posts</li>
        <li><strong>BookBub promotions:</strong> Expensive but worth it for series starters</li>
        <li><strong>Goodreads advertising:</strong> Cheaper than Amazon, targets engaged readers</li>
        <li><strong>Fantasy book bloggers:</strong> Still influential in our genre</li>
        <li><strong>Convention networking:</strong> Expensive but builds genuine industry relationships</li>
      </ul>
      <p><strong>Ineffective strategies:</strong></p>
      <ul>
        <li><strong>Generic Facebook ads:</strong> Too expensive, poor targeting</li>
        <li><strong>Twitter follower purchases:</strong> Worthless vanity metrics</li>
        <li><strong>Blog tour services:</strong> Mostly ineffective unless you curate carefully</li>
        <li><strong>Mass Kindle Unlimited stuffing:</strong> Hurts long-term discoverability</li>
      </ul>

      <h2>The Creative-Business Balance</h2>
      ...
      <ul>
        <li>Does this plot change serve the story or just marketability?</li>
        <li>Am I pushing characters toward actions that feel forced but commercially appealing?</li>
      ...
      <ul>
        <li>Regular communication about publication schedules</li>
        <li>Transparent updates about creative challenges</li>
        <li>Advanced reader copies for super-fans who provide feedback</li>
        <li>Character consistency across books (detailed series bibles are crucial)</li>
      </ul>
      <p><strong>Strategies that backfire:</strong></p>
      <ul>
        <li>Promising publication dates you can&apos;t meet</li>
        <li>Dramatically changing tone between books without warning</li>
        <li>Killing beloved characters purely for shock value</li>
        <li>Ignoring reader feedback completely</li>
      </ul>

      <h2>Tools and Resources That Actually Help</h2>

      <h3>Writing and Organization</h3>
      <p><strong>Series Bible Management:</strong></p>
      <ul>
        <li>Scrivener for complex project organization</li>
        <li>World Anvil for world-building tracking</li>
        <li>Excel/Google Sheets for character arc tracking</li>
      </ul>
      <p><strong>Writing Process:</strong></p>
      <ul>
        <li>Dragon Naturally Speaking for first drafts</li>
        <li>ProWritingAid for self-editing</li>
        <li>Vellum for professional formatting (Mac only, worth every penny)</li>
      </ul>

      <h3>Marketing and Business</h3>
      <p><strong>Analytics and Tracking:</strong></p>
      <ul>
        <li>KDP Dashboard (obviously, but track everything)</li>
        <li>BookReport for sales tracking across platforms</li>
        <li>Newsletter analytics (ConvertKit, Mailchimp, whatever you use)</li>
      </ul>
      <p><strong>Promotional Tools:</strong></p>
      <ul>
        <li>BookBub Partner Dashboard</li>
        <li>StoryOrigin for cross-promotions</li>
        <li>NetGalley for professional reviews (expensive but effective)</li>
      </ul>

      <h2>What I&apos;d Do Differently: The Honest Retrospective</h2>

      <h3>If I Started Over Tomorrow</h3>
      <p><strong>I would:</strong></p>
      <ul>
        <li>Write books 1-3 completely before publishing anything</li>
        <li>Invest in professional marketing consultation from day one</li>
        <li>Build my email list for six months before launching</li>
        <li>Create more detailed world-building resources for readers</li>
        <li>Start networking with other fantasy authors immediately</li>
      </ul>
      <p><strong>I wouldn&apos;t:</strong></p>
      <ul>
        <li>Stress about social media follower counts</li>
        <li>Try to be active on multiple platforms simultaneously</li>
        <li>Rush book releases to meet arbitrary deadlines</li>
        <li>Undersell my books to chase quick sales</li>
        <li>Skip professional editing (ever, for any reason)</li>
      </ul>
      ...
      <p>Focus on:</p>
      <ul>
        <li><strong>Consistent quality</strong> across all books</li>
        <li><strong>Professional presentation</strong> that builds trust</li>
        <li><strong>Genuine reader relationships</strong> that create word-of-mouth marketing</li>
        <li><strong>Long-term audience building</strong> over quick wins</li>
      </ul>

      <h2>The 2026 Self-Publishing Landscape</h2>
      ...
      <ul>
        <li>Morally complex protagonists</li>
        <li>Political intrigue with personal stakes</li>
        <li>Diverse fantasy worlds beyond European medieval settings</li>
        <li>Series with satisfying individual book arcs within larger narratives</li>
      </ul>

      <h3>Platform Changes to Watch</h3>
      <p><strong>Amazon continues evolving:</strong></p>
      <ul>
        <li>KDP Select benefits are increasing</li>
        <li>Algorithm changes favor consistent publishers</li>
        <li>International expansion creates new markets</li>
      </ul>
      <p><strong>Alternative platforms gaining ground:</strong></p>
      <ul>
        <li>Draft2Digital&apos;s partnership with libraries</li>
        <li>Kobo&apos;s international reach</li>
        <li>Direct-to-reader platforms like Bookfunnel</li>
      </ul>
      ...
      <ol>
        ...
        <li><strong>Study successful fantasy launches</strong> in your specific subgenre</li>
        <li><strong>Budget realistically</strong> for professional presentation</li>
